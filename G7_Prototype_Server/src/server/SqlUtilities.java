...
public class SqlUtilities {
	...
	public static void removeCheckedExam(CheckedExam checkedExam, Connection connection)
			throws SQLException {
		PreparedStatement remove = connection.prepareStatement(SqlUtilities.REMOVE_checkedExam);
		remove.setString(1, checkedExam.getSubmittedExam().getStudentInActiveExam().getActiveExam().getExam().getSubjectID());
		remove.setString(2, checkedExam.getSubmittedExam().getStudentInActiveExam().getActiveExam().getExam().getCourseID());
		remove.setString(3, checkedExam.getSubmittedExam().getStudentInActiveExam().getActiveExam().getExam().getExamNum());
